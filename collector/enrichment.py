...
def enrich(port):
 a=getjson(port,'https://ipwho.is/');ip=a.get('ip');cc=a.get('country_code') or '';country=a.get('country') or 'Unknown';conn=a.get('connection') or {};b={};asn=str(conn.get('asn') or '');org=conn.get('org') or ''
