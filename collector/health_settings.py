...
DEFAULT={'enabled':True,'retry_seconds':30,'recheck_seconds':300,'upload_bytes':32768,'download_kb':64,'max_concurrency':8,'min_active_providers':2,'probe_timeout':4,'connect_timeout':2,'startup_timeout_ms':1200,'batch_multiplier':3}
def load():
