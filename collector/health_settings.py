...
DEFAULT={'enabled':True,'retry_seconds':30,'recheck_seconds':300,'upload_bytes':32768,'download_kb':64,'max_concurrency':4,'min_active_providers':2}
def load():
